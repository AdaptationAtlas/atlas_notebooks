...
What story or analysis will it add to the Africa Adaptation Atlas? Who will use
this notebook?

## Suggested Data and Data Requirements

List the datasets that need to be sourced. Include any notes about links,
access, preprocessing, or gaps.
