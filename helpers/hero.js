import{readNotebookConfig as m,SITE_ROOT as g}from"./notebook.js";const d="http://www.w3.org/2000/svg";function h(){const t=document.createElementNS(d,"svg");t.classList.add("atlas-hero__mark"),t.setAttribute("viewBox","0 0 32 27");const e=document.createElementNS(d,"path");return e.setAttribute("fill","white"),e.setAttribute("stroke","white"),e.setAttribute("stroke-width",".5"),e.setAttribute("d",`M 31.60,25.63
