...
```{=html}
<div id="toc" style="margin-bottom: 30px;"></div>
...
function renderTOC() {
  ...
  // Start HTML
  let tocHtml = '<h2 style="margin-bottom: 10px;">Sections:</h2>';
  tocHtml += '<div style="display: flex; flex-wrap: wrap; gap: 6px; align-items: center;">';

  // Add links inline with separators
  ...
  sectionNames.forEach((section, i) => {
    ...
    tocHtml += `
      ...
      ${i < sectionNames.length - 1 ? '<span style="color: #999;">|</span>' : ''}
    `;
  });
