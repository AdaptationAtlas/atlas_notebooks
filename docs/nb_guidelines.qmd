...
These provide the hero, table of contents, language wiring, contributors,
appendix, and source-code link. Notebook-specific charts and narrative remain
in the entry file.
...
Use an explicit id when a heading needs a stable link or must be named in the
TOC ignore list.
