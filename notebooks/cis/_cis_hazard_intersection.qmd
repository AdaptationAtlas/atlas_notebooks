...
s2BivariateMap = {
  ...
  function bi_legend(selection) {
    ...
    // CIS Readiness label - along Top-RIGHT edge (starts at top, goes down-right)
    // Anchored at top corner, rotated 45 degrees
    selection
      .append("text")
      .attr("x", centerX + 10)
      ...
      .attr("dominant-baseline", "auto") // text sits above the line
      .attr("transform", `rotate(45, ${centerX + 10}, ${centerY - diagonalOffset - 5})`)
      .text("CIS Readiness →");
    
    // Hazard Severity label - along Top-LEFT edge (starts at top, goes down-left)
    // Anchored at top corner, rotated -45 degrees
    selection
      .append("text")
      .attr("x", centerX - 10)
