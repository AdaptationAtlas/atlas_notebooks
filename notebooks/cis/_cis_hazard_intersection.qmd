...
// Synchronized admin selectors for Section 2
viewof s2Admin0 = {
  selectedAdmin0Value;
  return createSyncedAdminSelector(
    0, viewof selectedAdmin0, selectedAdmin0Value, 
    uniqueAdmin0.map(d => ({ value: d, label: d })), 
    "s2", "admin0Label", "admin0Placeholder"
  );
}
...
viewof s2Admin1 = {
  ...
  admin1Options;
  return createSyncedAdminSelector(
    1, viewof selectedAdmin1, selectedAdmin1Value, 
    admin1Options.map(d => ({ value: d, label: d })), 
    "s2", "admin1Label", "admin1Placeholder"
  );
}
...
viewof s2Admin2 = {
  ...
  admin2Options;
  return createSyncedAdminSelector(
    2, viewof selectedAdmin2, selectedAdmin2Value, 
    admin2Options.map(d => ({ value: d, label: d })), 
    "s2", "admin2Label", "admin2Placeholder"
  );
}
```
...
// Inline admin level selectors for this section
htl.html`
