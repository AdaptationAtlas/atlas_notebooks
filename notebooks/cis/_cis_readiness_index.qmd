        ...
        ${Plot.plot({
          ...
          marks: [
            Plot.geo(s11MapData, {
              ...
              stroke: "#333",
              strokeWidth: 0.5,
              title: d => `${d.properties.regionName}\nWeather Station: ${d.properties.weatherStation != null ? d.properties.weatherStation.toFixed(3) : 'N/A'}\nClass: ${d.properties.weatherStationClass}`
            })
          ]
        })}
      </div>
        ...
        ${Plot.plot({
          ...
          marks: [
            Plot.geo(s11MapData, {
              ...
              stroke: "#333",
              strokeWidth: 0.5,
              title: d => `${d.properties.regionName}\nCloud Cover: ${d.properties.cloudCover != null ? d.properties.cloudCover.toFixed(3) : 'N/A'}\nClass: ${d.properties.cloudCoverClass}`
            })
          ]
        })}
      </div>
      ...
      marks: [
        Plot.geo(s12MapData, {
          ...
          title: d => {
            ...
            const fullName = regionName === country ? regionName : `${regionName}, ${country}`;
      ...
      marks: [
        ...
        Plot.geo(belowThreshold, {
          ...
          title: d => `${d.properties.admin0_name || d.properties.admin1_name || d.properties.admin2_name}\n` +
                      `CIS Readiness: ${d.properties.cisReadiness?.toFixed(3) || 'N/A'} (Below threshold)\n` +
        ...
        Plot.geo(aboveThreshold, {
          ...
          strokeWidth: 1.5,
          title: d => `${d.properties.admin0_name || d.properties.admin1_name || d.properties.admin2_name}\n` +
                      `CIS Readiness: ${d.properties.cisReadiness?.toFixed(3) || 'N/A'} (Above threshold)\n` +
                      `Class: ${d.properties.cisReadinessClass}\n` +
                      `Weather Station: ${d.properties.weatherStationClass}\n` +
                      `Cloud Cover: ${d.properties.cloudCoverClass}\n` +
                      `Precip Agreement: ${d.properties.precipAgreementClass}\n` +
