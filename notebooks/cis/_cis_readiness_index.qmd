...
// Track admin0 changes - when this changes, admin1 cell recreates and resets
admin0Key = selectedAdmin0Value.join(',')

viewof selectedAdmin1 = {
  // Make reactive to admin0Key - cell recreates when admin0 changes
  // When cell recreates, selector is recreated with empty selection (reset behavior)
  admin0Key;
  ...
  const selector = multiSelect({
    ...
    selected: [], // Reset when admin0 changes (cell recreates)
    maxSelections: 10
  });
...
// Track admin0 and admin1 changes - when this changes, admin2 cell recreates and resets
admin0Admin1Key = `${selectedAdmin0Value.join(',')}|${selectedAdmin1Value.join(',')}`

viewof selectedAdmin2 = {
  // Make reactive to admin0Admin1Key - cell recreates when admin0 or admin1 changes
  // When cell recreates, selector is recreated with empty selection (reset behavior)
  admin0Admin1Key;
  ...
  const selector = multiSelect({
    ...
    selected: [], // Reset when admin0 or admin1 changes (cell recreates)
    maxSelections: 10
  });
...
// Synchronized admin selectors for Section 1.2
// Make reactive to master value - createSyncedAdminSelector handles updates
viewof s12Admin0 = {
  // Make reactive to master value
  selectedAdmin0Value;
  return createSyncedAdminSelector(
    0, viewof selectedAdmin0, selectedAdmin0Value, 
    uniqueAdmin0.map(d => ({ value: d, label: d })), 
    "s12", "admin0Label", "admin0Placeholder"
  );
}

viewof s12Admin1 = {
  // Make reactive to master value and options
  selectedAdmin1Value;
  admin1Options;
  return createSyncedAdminSelector(
    1, viewof selectedAdmin1, selectedAdmin1Value, 
    admin1Options.map(d => ({ value: d, label: d })), 
    "s12", "admin1Label", "admin1Placeholder"
  );
}
...
viewof s12Admin2 = {
  ...
  return createSyncedAdminSelector(
    ...
    "s12", "admin2Label", "admin2Placeholder"
  );
}
```
...
// Synchronized admin selectors for Section 1.3
viewof s13Admin0 = {
  selectedAdmin0Value;
  return createSyncedAdminSelector(
    0, viewof selectedAdmin0, selectedAdmin0Value, 
    uniqueAdmin0.map(d => ({ value: d, label: d })), 
    "s13", "admin0Label", "admin0Placeholder"
  );
}
...
viewof s13Admin1 = {
  ...
  return createSyncedAdminSelector(
    1, viewof selectedAdmin1, selectedAdmin1Value, 
    admin1Options.map(d => ({ value: d, label: d })), 
    "s13", "admin1Label", "admin1Placeholder"
  );
}
...
viewof s13Admin2 = {
  ...
  return createSyncedAdminSelector(
    2, viewof selectedAdmin2, selectedAdmin2Value, 
    admin2Options.map(d => ({ value: d, label: d })), 
    "s13", "admin2Label", "admin2Placeholder"
  );
}
```
...
// Synchronized admin selectors for Section 1.4
viewof s14Admin0 = {
  selectedAdmin0Value;
  return createSyncedAdminSelector(
    0, viewof selectedAdmin0, selectedAdmin0Value, 
    uniqueAdmin0.map(d => ({ value: d, label: d })), 
    "s14", "admin0Label", "admin0Placeholder"
  );
}
...
viewof s14Admin1 = {
  ...
  return createSyncedAdminSelector(
    1, viewof selectedAdmin1, selectedAdmin1Value, 
    admin1Options.map(d => ({ value: d, label: d })), 
    "s14", "admin1Label", "admin1Placeholder"
  );
}
...
viewof s14Admin2 = {
  ...
  return createSyncedAdminSelector(
    2, viewof selectedAdmin2, selectedAdmin2Value, 
    admin2Options.map(d => ({ value: d, label: d })), 
    "s14", "admin2Label", "admin2Placeholder"
  );
}
```
