...
s3BivariateMap = {
  ...
  const classes = ["Low", "Moderate", "High"];
    ...
    // Access label (along the top-right edge of the diamond, rotated +45°)
    selection
      .append("text")
  ...
  // Add legend to SVG - integrated with map, positioned closer
  const legendX = 650; // Position to the right of the map
  const legendY = 480; // Aligned with bottom of map
