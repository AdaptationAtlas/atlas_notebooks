...
viewof s3AccessType = Inputs.radio(
  ["combined", "internet", "tv", "cellphone"],
  {
    ...
    value: "combined",
    format: x => x === "combined" ? nbText.s3AccessCombined :
                 x === "internet" ? nbText.s3AccessInternet :
                 x === "tv" ? nbText.s3AccessTV :
                 nbText.s3AccessCellphone
  }
)
```
...
viewof s3SortBy = {
  ...
  return Inputs.select(
    ["readiness", "combined", "internet", "tv", "cellphone"],
    {
      label: nbText.s3SortBy,
      value: "readiness",
      format: x => x === "readiness" ? nbText.s3SortReadiness :
                   x === "combined" ? nbText.s3AccessCombined :
                   x === "internet" ? nbText.s3AccessInternet :
                   x === "tv" ? nbText.s3AccessTV :
                   nbText.s3AccessCellphone
    }
...
s3CurrentAccessLabel =
  s3AccessType === "combined"
    ? nbText.s3AccessCombined
    : s3AccessType === "internet"
      ? nbText.s3AccessInternet
      : s3AccessType === "tv"
        ? nbText.s3AccessTV
        : nbText.s3AccessCellphone;
...
function getS3ScatterFacetData() {
  ...
  s3ProcessedData.forEach(d => {
    if (d.combined_norm != null && !isNaN(d.combined_norm)) {
      facetData.push({
        ...d,
        accessType: nbText.s3AccessCombined,
    ...
    if (d.internet_norm != null && !isNaN(d.internet_norm)) {
      facetData.push({
        ...d,
        accessType: nbText.s3AccessInternet,
    ...
    if (d.cellphone_norm != null && !isNaN(d.cellphone_norm)) {
      facetData.push({
        ...d,
        accessType: nbText.s3AccessCellphone,
