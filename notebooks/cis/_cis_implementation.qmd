...
s3AccessData = await d3.csv("/data/cis/CIS_access.csv", row => {
  return {
    ...
    iso3: row.iso3,
    gaul0_code: row.gaul0_code !== "\\N" && row.gaul0_code !== "" ? parseInt(row.gaul0_code) : null,
    gaul1_code: row.gaul1_code !== "\\N" && row.gaul1_code !== "" ? parseInt(row.gaul1_code) : null,
    gaul2_code: row.gaul2_code !== "\\N" && row.gaul2_code !== "" ? parseInt(row.gaul2_code) : null,
...
s3UniqueCountries = Array.from(new Set((section3Data || []).map(d => d.admin0_name))).sort()

viewof s3FilteredCountries = multiSelect({
...
viewof s3HighlightedCountries = multiSelect({
  ...
  if (typeof downloadButton === 'undefined' || !s3SortedData || s3SortedData.length === 0) {
    ...
    yield downloadButton(
      s3SortedData.map(d => ({
        ...
        "TV Access 0-1": d.tv_norm !== null ? d.tv_norm.toFixed(3) : "N/A",
        "Internet Access %": d.internet_pct !== null ? d.internet_pct.toFixed(1) : "N/A",
        "Internet Access 0-1": d.internet_norm !== null ? d.internet_norm.toFixed(3) : "N/A",
        "Cellphone Access %": d.cellphone_pct !== null ? d.cellphone_pct.toFixed(1) : "N/A",
        "Cellphone Access 0-1": d.cellphone_norm !== null ? d.cellphone_norm.toFixed(3) : "N/A",
        "Combined Access %": d.combined_pct !== null ? d.combined_pct.toFixed(1) : "N/A",
        "Combined Access 0-1": d.combined_norm !== null ? d.combined_norm.toFixed(3) : "N/A",
