...
// Load CIS readiness at Admin0 (country) level (possibly current limit)
...
section3Data = {
  ...
  return s3CisReadinessAdmin0.map(cis => {
     //TODO: @Brayden make sure admin 1 exists and is allowed
...
```{ojs}
s3Insights = {
  const avgReadiness = d3.mean(section3Data, d => d.cis_readiness_avg);
