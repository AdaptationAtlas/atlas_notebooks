...
// Also calculate a "combined" access metric (average of TV, internet, cellphone)
// and normalize all access percentages to 0-1 scale for comparison.
// ============================================================================
...
s3BivariateMap = {
  ...
  const classes = ["Low", "Moderate", "High"];
    ...
    // Calculate the rotated diamond corners for proper label positioning
    // After 45° rotation, the diamond extends from the center by totalWidth/2 * sqrt(2)
    const diagonalOffset = (totalWidth / 2) * Math.sqrt(2);
    
    // CIS Readiness label (along bottom-right edge, from bottom corner to right corner)
    // Position at bottom-right of diamond, text runs along the edge
    selection
      .append("text")
      .attr("x", centerX + diagonalOffset + 15)
      .attr("y", centerY + diagonalOffset + 15)
      .attr("font-size", "11")
      .attr("fill", "#333")
      .attr("font-weight", "600")
      .attr("text-anchor", "start")
      .attr("dominant-baseline", "hanging")
      .attr("transform", `rotate(-45, ${centerX + diagonalOffset + 15}, ${centerY + diagonalOffset + 15})`)
      .text(_lang(cis.s3ReadinessLabel) + " →");
    
    // Access label (along top-right edge, from top corner to right corner)
    // Position at top-right of diamond, text runs along the edge
    selection
      .append("text")
      .attr("x", centerX + diagonalOffset + 15)
      .attr("y", centerY - diagonalOffset - 5)
      .attr("font-size", "11")
      .attr("fill", "#333")
      .attr("font-weight", "600")
      .attr("text-anchor", "start")
      .attr("dominant-baseline", "auto")
      .attr("transform", `rotate(45, ${centerX + diagonalOffset + 15}, ${centerY - diagonalOffset - 5})`)
      ...
      yield html`<div style="width: 100%; overflow-x: auto;">
        ...
        ${Plot.plot({
          ...
          fx: {
            label: null,
            padding: 0.05,
            domain: [_lang(cis.s3AccessCombined), _lang(cis.s3AccessInternet), _lang(cis.s3AccessTV), _lang(cis.s3AccessCellphone)]
          },
          marks: [
