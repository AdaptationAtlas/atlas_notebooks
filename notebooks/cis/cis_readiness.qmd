...
**Lead Developer:** [Johnson Mwakazi](https://www.linkedin.com/in/johnson-mwakazi/)
...
```{ojs}
mutable hoverCountry = "SSA" // Used by _template_plot.qmd for map hover interactions
```
