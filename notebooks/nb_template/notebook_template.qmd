...
```{ojs}
// NOTE: Quarto resolves paths from the project root. If this import fails,
// try switching to a relative path like "./../../helpers/uiComponents.ojs".

import { atlasTOC, atlasHero } from "/helpers/uiComponents.ojs"

hero_url = "/images/test_im.webp"

atlasHero(nbTitle, hero_url) //nbTitle is defined on line: x 
```
...
<!-- The above ^  {{< include path.qmd >}} alows for modular import of code. This is performed on build, so there are no performance implications  -->
...
Todd Rosenstock, Brayden Youngberg, Pete Stewart. `{ojs} nbTitle.` Adaptation Atlas. https://adaptationatlas.cgiar.org/
...
keyInsights = {
  ...
  let fill_items = [
      { name: "country", value: hoverCountry }, // _lang({en: 'Chad', fr: 'Tchad'})
