...
```{ojs}
{
  const data_topo = await FileAttachment("/data/shared/atlas_gaul24_a1_africa_simple-vlowres.topojson").json();

  const data = topojson.feature(data_topo, data_topo.objects["atlas_gaul24_a1_africa"]);
