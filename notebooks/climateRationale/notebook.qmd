...
<style>
  ...
  /* Small "→ Methods" link sitting inline with each section H1 to save
     vertical space. */
  .section-methods-link {
    font-size: 0.4em;
    color: #555;
  ...
  .section-methods-link::before {
    content: "→ ";
  }
  .section-methods-link:hover {
    color: #2E7636;
...
# `{ojs} heading2` <a href="#methods-socioeconomic" class="section-methods-link">Methods</a> {#keyFacts}
...
# `{ojs} heading3` <a href="#methods-climate-data" class="section-methods-link">Methods</a> {#recentChanges}
...
# `{ojs} heading4` <a href="#methods-climate-data" class="section-methods-link">Methods</a> {#futureProjections}
...
# `{ojs} heading5` <a href="#methods-extreme-events" class="section-methods-link">Methods</a> {#extremeEvents}
...
# `{ojs} heading6` <a href="#methods-hazard-exposure" class="section-methods-link">Methods</a> {#hazardExposure}
