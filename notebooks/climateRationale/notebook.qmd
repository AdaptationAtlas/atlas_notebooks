...
recentChanges_obs = {
  ...
  const compositeChartLegendPng = async () => {
    ...
    // Layer 1 — chart SVG. Plot.plot returns a self-contained SVG;
    // serialize it standalone and rasterise via Image.
    const chartSvgString = new XMLSerializer().serializeToString(chart);
