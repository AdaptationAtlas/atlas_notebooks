...
futureProjections_data = {
  ...
  // Narrowing from all 9 hazards to 2-3 cuts cold-fetch bytes ~3-4×.
  // Trade-off: switching the selected hazard now triggers a refetch
  // instead of just a JS filter — accepted since hazard switches are
  // uncommon during initial exploration, and the warm cache catches
  // subsequent switches between HSH-max and PTOT.
