...
viewof anomaly_obs = {
  ...
  if (isSPEI) toggle.style.display = 'none';
  return toggle;
}
```
...
viewof monthly_obs = {
  ...
  // "monthly resolution" toggle has no meaning. Hide the toggle rather
  // than disabling it — disabled controls labelled "N/A" still consume
  // grid real-estate and add visual noise.
  if (isSPEI) toggle.style.display = 'none';
  return toggle;
}
```
