...
futureProjections_dataAll = {
  ...
  SELECT
    ...
    sd,
    sd_anomaly,
    -- CR-060 percentile columns shipped 2026-06-01 (canonical 20/20 PASS).
    -- 17–83 % inter-model range = AR6 'likely' calibrated-language band;
    -- replaces the prior mean ± 1 σ ribbon in timeseries_futureProjections
    -- and the dot-and-whisker bounds in summary_futureProjections.
    q17,
    q83,
    q17_anomaly,
    q83_anomaly,
