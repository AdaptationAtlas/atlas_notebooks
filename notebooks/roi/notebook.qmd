---
pagetitle: "Econimic Returns on Investment"
nb-authors:
  - Brayden Youngberg
  - Pete Stewart
...
renderProductionBars = () => {
  ...
  const _title = _lang({
    ...
    fr: "Total VoP pour les régions et les cultures sélectionnées dans chaque pays"
  })
...
downloadCsvButton(walkthroughEconomicIndicators?.enriched, {
  ...
  label: _lang({ en: "Download", fr: "Télécharger" }),
});
```
...
# `{ojs} contributions` {#contributions}
