...
//   fig1_farmsize: await FileAttachment(
//     "/data/lossDamageNb/fig1_farmsizelookup.parquet",
//   ),
//   fig1_data: await FileAttachment("/data/lossDamageNb/fig1_allshps.parquet"),
//   fig4a_data: await FileAttachment(
//     "/data/lossDamageNb/fig3_map_fin_spei12_high.parquet",
//   ),
//   fig4b_data: await FileAttachment("/data/lossDamageNb/fig4b.parquet"),
// });
...
fig3_data = await FileAttachment(
  "./../../data/lossDamageNb/figure3_spei.json",
).json();
```
...
fig4a_arrayBuf = await FileAttachment(
  "/data/lossDamageNb/fig4_map_fin_spei12_hiigh.parquet",
).arrayBuffer();
...
renderS4b_plot = () => {
  return Plot.plot({
    ...
    color: {
      legend: true,
      label: "Threshold",
      domain: ["Farms Likely Impacted", "40% lost revenue", "50% lost revenue"],
