...
```{=html}
<img class='hero_image' src="../images/test_im.webp" style="width: 100%; height: 175px; object-fit: cover; overflow: hidden;"/>
```
...
`{ojs} _lang(general_translations.citation)`:
...
nbTitle = _lang({en: "This is a template for to build Atlas notebooks", fr: "Ceci est un modèle pour construire des notebooks Atlas"})
...
keyInsights = {
  let template = _lang({
        en: `This is where come key insights should go, they will be dynamic based on the selections such as country (**:::country:::**) and crop type (**:::cropType:::**)`,
